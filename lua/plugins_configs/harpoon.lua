return {
    ...
    config = function ()
        ...
        vim.keymap.set('n', '<leader>h', function() require('harpoon.ui').toggle_quick_menu() end, {noremap = true})
        vim.keymap.set('n', '<leader>ah', function() require("harpoon.mark").add_file() end, {noremap = true})
